...
const configSchema = z.object({
  ...
  HUMAN_OPERATIONS_BASE_URL: z.url(),
  ...
  HUMAN_OPERATIONS_WORKFLOW_HMAC_SECRET: z.string().min(32),
  HUMAN_OPERATIONS_WORKFLOW_ISSUER: z.string().min(1).default('customer-service-os-workflow-workers'),
});
